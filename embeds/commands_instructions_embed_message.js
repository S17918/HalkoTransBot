        ...
        if(messages.size === 0){
            ...
            let embed = new Discord.MessageEmbed()
                ...
                .addFields(
                    ...
                    {name: '!addDLC <DLC ID>  |  !addAllDLC', value: 'Dodaje informację o DLC potrzebnym do wzięcia udziału w konwoju. Należy podać ID rangi danego DLC. ID są dostępne w liście niżej. Komendy można używać kilkukrotnie - DLC są dodawane do listy. W przypadku **ProMods** należy dodać wszystkie DLC za pomocą drugiej komendy'},
                    ...
                    {name: '!clearConvoyData  |  !ccd', value: 'Czyści podane wcześniej dane'},
